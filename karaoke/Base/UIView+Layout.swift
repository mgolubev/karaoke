...
public extension UIView {
    ...
    func pinToLayout(guide: UILayoutGuide, left: CGFloat = 0, top: CGFloat = 0, right: CGFloat = 0, bottom: CGFloat = 0) {
        translatesAutoresizingMaskIntoConstraints = false
        leftAnchor.constraint(equalTo: guide.leftAnchor, constant: left).isActive = true
        topAnchor.constraint(equalTo: guide.topAnchor, constant: top).isActive = true
        rightAnchor.constraint(equalTo: guide.rightAnchor, constant: -right).isActive = true
...
public func * (lhs: NSLayoutDimension, rhs: CGFloat) -> DimensionAttribute {
    return DimensionAttribute(anchor: lhs, multiplier: rhs)
}
...
@discardableResult
public func ~= (lhs: NSLayoutDimension, rhs: DimensionAttribute) -> NSLayoutConstraint {
